                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <div class="input-group input-group-merge">
                                ...
                                ></span>
                                <input
                                  type="text" value="{{ old('jenis_laporan', $kategori->jenis_laporan) }}"
                                  class="form-control @error('jenis_laporan')
                                      is-invalid
                                  @enderror"
                                  name="jenis_laporan"
                                  id="basic-icon-default-fullname"
                                  placeholder="Enter jenis_laporan"
                                  aria-label="Enter jenis_laporan"
