        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="modalCenterTitle">Add New Kategori Laporan</h5>
                          <button
                            type="button"
                            class="btn-close"
                          ...
                          <div class="row">
                            <div class="col mb-3">
                                <form action="{{ route('kategori.store') }}" method="post">
                                    @csrf
                              <label for="nameWithTitle" class="form-label">Jenis Laporan</label>
                              <input
                                type="text"
                                id="nameWithTitle"
                                name="jenis_laporan"
              ...
              <div class="card">
                <h5 class="card-header">List Data Laporan</h5>
                <div class="card-body">
                  <div class="table-responsive text-nowrap">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        @foreach ($kategori as $laporan )

                        <tr>
                            <td>
                            <i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $loop->iteration }}</strong>
                          </td>
                          <td><span class="badge bg-label-primary me-1">{{ $laporan->jenis_laporan }}</span></td>
                          <td>
                              <div class="dropdown">
                              <button
                                type="button"
                            ...
                            <div class="dropdown-menu">
                                <div class="col-lg-4 col-md-6">
                                    <div class="mt-3 mb-3">
                                        <a class="dropdown-item" href="{{ route('kategori.edit', $laporan->id) }}"
