        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Create New Petugas</h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Nama Admin</label>
                          <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-phone">No_hp Admin</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input
                                ...
                                class="form-control email-mask @error('email')
                                is-invalid
                            @enderror"
                                name="email"
                        ...
                        <div class="row mb-3 form-password-toggle">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-lock">Password</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-lock" class="input-group-text"
                                ><i class="bx bx-lock"></i
                              ></span>
                              <input
                                type="password"
                                id="basic-icon-default-company"
                                class="form-control lock-mask @error('password')
                                is-invalid
                            @enderror"
                                name="password"
