        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Tambah Laporan Baru</h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="{{ route('laporan.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Kategori Laporan</label>
                          <div class="col-sm-10">
                            ...
                            <div class="input-group input-group-merge">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" id="inputGroupSelect01" name="wilayah_id">
                                      ...
                                      <option value="{{ $wila->id }}">{{ $wila->wilayah }}</option>
                                      @endforeach
                                    </select>
                                  </div>
                                  @error('wilayah_id')
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                <div class="input-group">
                                    <input type="file" id="image" value="{{ old('documentasi') }}" onchange="previewImage()" name="documentasi" class="form-control @error('documentasi')
                                    is-invalid
